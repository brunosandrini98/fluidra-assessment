...
def build_response(
    ...
    trace = Trace(search_calls=search_calls, revisions=revisions, verdict=verifier.verdict if verifier else None)
    ...
    citations = [
        Citation(
            id=cid,
            chunk_id=chunk_id,
            document=retrieved[chunk_id].document,
            page=retrieved[chunk_id].page,
            page_in_language=None,
            section=retrieved[chunk_id].section,
            quote=quote_span(quotes[chunk_id], retrieved[chunk_id].text),
        )
